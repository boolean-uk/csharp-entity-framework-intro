...
namespace exercise.webapi.Data
{
    public class Seeder
    {
        ...
        private List<string> _firstpubword = new List<string>()
        {
            "Applewood", 
            "Bellevue",
            "Libertas", 
        ...
        private List<string> _secondpubword = new List<string>()
        {
            "Books",
            "Publications",
            "Paperbacks",
        ...
        public Seeder()
        {
            ...
            for (int i = 1; i < 50; i++)
            {
                ...
                publisher.Id = i;
                publisher.Name = $"{_firstpubword[publisherRandom.Next(_firstpubword.Count)]} {_secondpubword[publisherRandom.Next(_secondpubword.Count)]}";
