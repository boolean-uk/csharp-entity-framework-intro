    ...
    public class Seeder
    {
        ...
        public Seeder()
        {
            ...
            for (int x = 1; x < 250; x++)
            {
                ...
                publisher.Id = x;
                publisher.Name = _firstnames[pubRandom.Next(_firstnames.Count)] + _secondword[pubRandom.Next(_secondword.Count)];
            ...
            for (int y = 1; y < 250; y++)
            {
                ...
                book.PublisherId = _publishers[authorRandom.Next(_authors.Count)].Id;
